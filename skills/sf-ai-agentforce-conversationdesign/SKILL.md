...
description: Conversation design skill for Salesforce Agentforce. Generates persona documents, topic architectures, instruction sets, utterance libraries, escalation matrices, and guardrail configurations. Validates existing agents against conversation design best practices with 120-point scoring.
license: MIT
metadata:
  version: 1.0.0
  ...
  short-description: Conversation design skill for Salesforce Agentforce. Generates persona documents, topic architectures, instruction sets, utterance libraries, escalation matrices, and guardrail configurations. Validates existing agents against conversation design best practices with 120-point scoring.
---
...
export SKILL_DIR="$CODEX_HOME/skills/sf-ai-agentforce-conversationdesign"
