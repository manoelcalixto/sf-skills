...
description: Extract and analyze Agentforce session tracing data from Salesforce Data 360. Supports high-volume extraction (1-10M records/day), Polars-based analysis, and debugging workflows for agent sessions.
license: MIT
metadata:
  version: 1.0.0
  ...
  short-description: Extract and analyze Agentforce session tracing data from Salesforce Data 360. Supports high-volume extraction (1-10M records/day), Polars-based analysis, and debugging workflows for agent sessions.
---
...
export SKILL_DIR="$CODEX_HOME/skills/sf-ai-agentforce-observability"
