...
metadata:
  ...
  short-description: Generates and reviews Salesforce Apex code with 2025 best practices and 150-point scoring. Use when writing Apex classes, triggers, test classes, batch jobs, or reviewing existing Apex code for bulkification, security, and SOLID principles.
---
...
export SKILL_DIR="$CODEX_HOME/skills/sf-apex"
...
1. **Marketplace folder**: `$CODEX_HOME/skills/sf-apex/templates/[template]`
2. **Project folder**: `[project-root]/sf-apex/templates/[template]`

**Example**: `Read: $CODEX_HOME/skills/sf-apex/templates/apex-class.cls`
...
**Path**: `$CODEX_HOME/skills/sf-apex/docs/`
