...
description: Creates and manages Salesforce Connected Apps and External Client Apps with 120-point scoring. Use when configuring OAuth flows, creating connected apps, setting up JWT bearer auth, or managing API access policies.
license: MIT
metadata:
  version: 1.1.0
  author: Jag Valaiyapathy
  scoring: 120 points across 6 categories
  short-description: Creates and manages Salesforce Connected Apps and External Client Apps with 120-point scoring. Use when configuring OAuth flows, creating connected apps, setting up JWT bearer auth, or managing API access policies.
---
...
export SKILL_DIR="$CODEX_HOME/skills/sf-connected-apps"
...
1. `$CODEX_HOME/skills/sf-connected-apps/templates/[template]`
