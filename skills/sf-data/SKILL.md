---
name: sf-data
description: Salesforce data operations expert with 130-point scoring. Use when writing SOQL queries, creating test data, performing bulk data operations, or importing/exporting data via sf CLI.
license: MIT
metadata:
  version: 1.1.0
  author: Jag Valaiyapathy
  scoring: 130 points across 7 categories
  short-description: Salesforce data operations expert with 130-point scoring. Use when writing SOQL queries, creating test data, performing bulk data operations, or importing/exporting data via sf CLI.
---
...
export SKILL_DIR="$CODEX_HOME/skills/sf-data"
...
- Marketplace: `$CODEX_HOME/skills/sf-data/templates/`
...
- **Path**: `$CODEX_HOME/skills/sf-data/templates/[subfolder]/`
