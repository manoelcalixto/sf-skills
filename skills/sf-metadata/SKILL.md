---
name: sf-metadata
description: Generates and queries Salesforce metadata with 120-point scoring. Use when creating custom objects, fields, profiles, permission sets, validation rules, or querying org metadata structures via sf CLI.
license: MIT
metadata:
  version: 1.1.0
  author: Jag Valaiyapathy
  scoring: 120 points across 6 categories
  short-description: Generates and queries Salesforce metadata with 120-point scoring. Use when creating custom objects, fields, profiles, permission sets, validation rules, or querying org metadata structures via sf CLI.
---
...
export SKILL_DIR="$CODEX_HOME/skills/sf-metadata"
...
1. **Marketplace folder**: `$CODEX_HOME/skills/sf-metadata/templates/[path]`
2. **Project folder**: `[project-root]/sf-metadata/templates/[path]`

**Example**: `Read: $CODEX_HOME/skills/sf-metadata/templates/objects/custom-object.xml`
...
- **Path**: `$CODEX_HOME/skills/sf-metadata/docs/`
...
```bash
python3 $CODEX_HOME/skills/sf-metadata/hooks/scripts/validate_metadata.py <file_path>
```
