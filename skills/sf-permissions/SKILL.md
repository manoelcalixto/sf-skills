---
name: sf-permissions
description: Permission Set analysis, hierarchy viewer, and "Who has X?" auditing. Use when analyzing permissions, visualizing PS/PSG hierarchies, or finding which Permission Sets grant access to specific objects, fields, or Apex classes.
license: MIT
metadata:
  version: 1.1.0
  author: Jag Valaiyapathy
  inspiration: PSLab by Oumaima Arbani (github.com/OumArbani/PSLab)
  short-description: Permission Set analysis, hierarchy viewer, and "Who has X?" auditing. Use when analyzing permissions, visualizing PS/PSG hierarchies, or finding which Permission Sets grant access to specific objects, fields, or Apex classes.
---
...
export SKILL_DIR="$CODEX_HOME/skills/sf-permissions"
...
```bash
cd $CODEX_HOME/skills/sf-permissions/scripts
